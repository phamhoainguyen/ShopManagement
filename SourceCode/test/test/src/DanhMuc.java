...
import database.ReadingExcelFile;
...
public class DanhMuc extends javax.swing.JPanel {
    ...
    private void jButton10ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton10ActionPerformed
        ...
        if(returnValue == JFileChooser.APPROVE_OPTION) {
            ...
            addDataFromExcelFile();
        }
    }//GEN-LAST:event_jButton10ActionPerformed
    
    
    private void addDataFromExcelFile(){
        
        
        // ----------------mo va ket noi database---------------------------
        try {
        ...
        // -----------------------open excel file----------------------------
        try {
            readFile = new ReadingExcelFile(filePath);
        ...
        for(int i = 1; i < readFile.getRowsNumber(); i++){
            Product product = readFile.getProductFromFile(i);
            queryData.insertProduct(product);
        }
        //------------------------------------------------------------------
        
        System.out.print("\n so record trong file excel: " + readFile.getRowsNumber());
        
        //--------------------dong csdl va dong file------------------------
        if(readFile != null)
            readFile.closeFile();
        if(queryData != null)
    ...
    private ReadingExcelFile readFile;
